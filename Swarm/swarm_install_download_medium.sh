...
for i in `seq 1 50`; 
do
    echo "Start downloading medium file"
    OUTPUT=$( { time $COMMANDDIR/swarm down bzz://f80169d0a2fab73c1f2bad2a21a6598f3397bb30d6bde0fc3de26ecd2249a280 /dev/null; } 2>&1 )
    echo "$OUTPUT" >> /home/sroobol/output/medium_file_download_$i.txt
    echo "Downloaded the medium file $i times" 
done
