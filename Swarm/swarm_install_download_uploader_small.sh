...
OUTPUT=$( $COMMANDDIR/swarm up /var/scratch/sroobol/files/small_file.txt ) 
echo "${OUTPUT}" > /var/scratch/sroobol/hash/small_hash.txt 
echo "${1}: uploaded small file hash" 

while [ ! -f /home/sroobol/output/small_file_download_50.txt ]; 
do
   sleep 2 
done
